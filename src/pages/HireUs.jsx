...
import  "../assets/css/hire-us-page.css"
import Home from '../component/section-component.js/Home'
import if4ab from "../assets/imgs/1F44B.png"
const HireUs = ({children}) => {
  return (
    <>
<Home>
<section className='hire-us-page' >
<div class= "hireUsFRM open"  >
        <div class="hireUsColRgt">
    <div className="heading">
        <h2>Have a project in mind</h2>
        <h1>Let's talk ! <img src={if4ab} alt="" title="Flutter Application Development" /></h1>
    </div>
